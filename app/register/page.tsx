...
import { ShieldCheck, Lock, Mail, Loader2, ChevronRight, AlertTriangle, User, Eye, EyeOff } from "lucide-react"
  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-6 relative z-10 flex flex-col items-center">
        ...
        <p className="text-[11px] text-gray-400">Join VexaNode and provision high-speed host nodes</p>
      </div>
      ...
      <form onSubmit={handleRegister} className="space-y-3 mb-4 relative z-10">
        ...
        {password.length > 0 && (
          <motion.div
            ...
            className="space-y-1.5 mt-1.5 pl-1"
          >
